...
async function eliminarEquipo(req, res) {
  ...
  try {
    ...
    const result = await sequelize.transaction(async (t) => {
      // Paso 1: Eliminar el equipo relacionado en la tabla 'computadora' (si existe)
      ...
      // Paso 2: Eliminar el componente relacionado en la tabla 'componente' (si existe)
      await sequelize.query(
      ...
      // Paso 3: Eliminar el registro del equipo en la tabla 'equipo_Activo' (si existe)
      await sequelize.query(
      ...
      // Paso 4: Eliminar el registro del equipo en la tabla 'clasificacion' (si existe)
      await sequelize.query(
